package com.one_to_one.hibernate.main;
...
import com.one_to_one.hibernate.model.Customer1;
import com.one_to_one.hibernate.model.Txn1;
import com.one_to_one.hibernate.util.HibernateAnnotationUtil;
...
public class HibernateOneToOneAnnotationMain {
	...
	private static Txn1 buildDemoTransaction() {
		...
		cust.setAddress("Gurgaon , Haryana");
		cust.setEmail("Kamal@yahoo.com");
		cust.setName("Kamal ");
